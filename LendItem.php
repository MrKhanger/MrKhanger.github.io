     ...
     <div>
      ...
      <div class="form-body"  >
        ...
        <div class="horizontal-group">
          ...
          <div class="form-group">
            <label for="P_Name" class="label-title"><b>Name of the book*</b></label>
        ...
        <!-- Product description -->
        <div class="form-group">
          <label for="P_Description" class="label-title"><b> Book description *</b></label>
        ...
        <div class="horizontal-group">
          <div class="form-group">
            <label for="P_Price" class="label-title"><b> Book price (In ₹) *</b></label>
            <input type="text" id="P_Price" class="form-input" placeholder="Price of the item " required="required" name="P_Price">
          </div>

          <div class="form-group">
            <label for="P_Price" class="label-title"><b> Your Address (To Pick Up The Book/s) *</b></label>
          ...
          <div class="form-group">
            <label for="P_Price" class="label-title"><b> Your location (For precision in location) *</b></label>
            <input type="text" id="P_Price" class="form-input" placeholder="Price of the item " required="required" name="P_Price">
          </div>
          ...
          <div class="form-group">
            <label for="P_Age" class="label-title"><b> Year of Publication (If Applicable)</b></label>
        ...
        <div class="horizontal-group">
          <div class="form-group left" >
            <label for="Product_Picture_1" class="label-title"><b> Book's Cover Picture * </b> </label>
            <input type="file" id="Product_Picture_1" size="80" name="Product_Picture_1"> <br><br>
            <label for="Product_Picture_3" class="label-title"><b> Book's Content Picture</b> </label>
            <input type="file" id="Product_Picture_3" size="80" name="Product_Picture_3">
          </div>
          
          <div class="form-group right">
          <label for="Product_Picture_2" class="label-title right"><b> Book's Index Picture* </b> </label>
