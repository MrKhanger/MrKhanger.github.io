...
<div class="leftcon">
    <form action="submit">
        ...
        <div id="Checkoutform">
            ...
            <div class="email-phone">
                    <button id="Edit" class="open-button">View</button>
                    <div id="myForm8">
                        <h2 style="margin: 4px 0px;">MY ORDERS HISTORY</h2>
                    </div>
            </div>
...
<div class="rightcon">
 ...
 -->
    ...
    <div id="Checkoutform">
        <div id="About-me">
            <h1 style="font-size: 2.4rem;">FOR SELLERS</h1>
            <div class="email-phone">
                <button id="Edit" class="open-button" onclick="openForm4()">View</button>
                <div id="myForm4">
                    <h2 style="margin: 4px 0px;">MY SOLD BOOKS</h2>
                </div>
            ...
            <div class="email-phone">
                <button id="Edit" class="open-button" onclick="openForm4()">View</button>
                <div id="myForm4">
                    <h2 style="margin: 4px 0px;">DASHBOARD</h2>
                </div>
            </div>
        </div>
    </div>
