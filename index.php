...
<nav id="NavStyle">
  ...
  <div id="main">
    <span style="font-size: 1.78rem;cursor:
			pointer; color: black; " onclick="openNav()"><i class="fa fa-bars" aria-hidden="true"></i>
    </span>
  </div>
  <!-- <hr style="width: 40%; color: white; position: left; margin: 0px; padding:0px;"> -->
  ...
  if (isset($_SESSION['user_signin'])) {
    echo '
        <a  style="position: absolute; right: 70px; top: 10px; text-decoration: none;color: black;"><img src="" alt="UserPic" style="position: absolute; right: 5px; top: -3px; text-decoration: none; width:30px;height:30px; border-radius:50%;" id="Userpic"></img></a>
        <a href="Cart.php"
    ...
    echo '<a type="button"  style="position: absolute; right: 70px; top: 12px; text-decoration: none;" onclick="LoginForm()"><i class="fa fa-user"
              aria-hidden="true" style="font-size: 1.1rem;color: black;"> Login/Sign Up</i></a>
              <a type="button" style="position: absolute; right: 40px; top: 10px;" onclick="LoginForm()"><i class="fa fa-shopping-bag" aria-hidden="true" style="font-size: 1.4rem;color: black;"></i><span class="badge badge-secondary" style="margin: 0px -6px; background-color: transparent;" id="CartItemCount"></span></a>';
...
<!-- BooksResell Banner -->
  ...
  <section>
  <?php
  include('Includes/Section02.php');
  ?>

  </section>

  <!-- Category sectio starts here -->

  <section>
  <?php
  include('Includes/Categories2.php');
  ?>

  </section>

  <!-- Category section ends starts here -->
...
<div class="RaiseReq" style= "display: flex;flex-direction: row-reverse;">

      <button id="Raise-Req-btn" class="btn-cart" onclick="RequestForm()"> <i class="fas fa-hand-sparkles"></i> Raise Request </button>
      <h4 style="display: block; text-align: end; margin: 10px;"> Can't find what you are looking for? </h4> 
</div>


<!-- Tab links -->
<div class="tab">
  <button class="tablinks" onclick="openRequests(event, 'Rent')" id="RentOpen">BUY</button>
  <button class="tablinks" onclick="openRequests(event, 'Requests')">REQUESTS</button>
  <button class="tablinks" onclick="openRequests(event, 'Lend')">SELL</button>
</div>
...
<div id="RIR"  class="LoginForm animate" style="display: none;">
            ...
            <div >
                <input type="email" class="element" name="myEmail" id="raise_item_name" placeholder="Name of the Book">
            </div>
            <div >
                <input type="text" class="element" id="raise_no_of_days" name="My number" placeholder="City">
            </div>
            <div >
                <textarea name="Description" class="element" id="raise_product_desc" cols="30" rows="3"  placeholder= "Book Description" ></textarea>
            </div>
...
<button id="ShowPrev"class="btn-cart">Prev</button>
<button id="ShowNext" class="btn-cart" style= "display: block;
    float: right;">Next</button>
</div>
  ...
  while($row = mysqli_fetch_assoc($result)) {
    ...
    <tr>
      ...
      <td><?php  echo $row["Item_Description"];?></td>
       <td> <button  class='fullfillreq btn-cancel' value="<?php echo  $row["id"];?>">SELL</button></td>
    </tr>
...
<div id="Lend" class="tabcontent">
  ...
  if (isset($_SESSION["user_signin"]))
    ...
    echo '<div class="row justify-content-center"><h2 class="" style= "text-align: center;">Currently You are not logged in.<button type="button" class="btn btn-outline-danger" data-dismiss="modal" data-toggle="modal" data-target="#LoginModal" id="LoginBtn">Login Required</button></h2></div>';
  ?>
</div>
...
<section>
  <?php
  include('Includes/HappyCustomers.php');
  ?>
...
<section class="container" style="margin-top: 60px;">
  ...
  <div class="row">
    <div class="col-lg-6 col-md-6">
      ...
      <p>
 Welcome to our platform BooksResell.com. Here you can Sell or Buy any book that you want. If you want to Sell anything. Click on our lend tab. Fill the lending form and boom! Your item is listed on our website for thousands of renters out there! <b>&#128512;</b>
      </p>
    </div>
    <div class="col-lg-6 col-md-6">
...
<section class="container-fluid contactsection">
  <div class="row" style="background-color: black;">
    <div class="col-lg-9 col-sm-12"><br><br>
      <h2 class="font-weight-bold textwhite" style="font-size: 3.85rem;">Contact Us </h2>
    </div>
...
<!-- <div id="Contact-Form-Img">



<img id= "Contact-Us-Img" src="https://cdn.pixabay.com/photo/2018/01/22/19/09/contact-us-3099716_960_720.jpg" alt="Contact Us">
...
<section class="container">
  <div class="row">
    ...
    <div class="col-lg-7 col-sm-12 text-center">
      ...
      <br>
      <p class="h2 font-weight-bold ">Explore BooksResell</p><br>
      <div class="row">
